...
In this lession, you will understand why a blockchain developer would prefer Solana for development, including:
...
This lession goes through the reasons why one should consider building on Solana. Smart contracts in Solana support multiple programming languages, including Rust, C, C++, Python, and Solidity. Solana has a massive community with low transaction costs, and it's significantly faster than Ethereum. You'll find plenty of tools to help you on your Solana development journey, and the next lession covers Solidity for Ethereum and Solana-compatible dApps.
...
![Ecosystem](/moduleimages/eco.jpg)
...
![current state](/moduleimages/curreco.jpeg)
