...
In this lession, we go through an overview of the content of the course and learn how to utilise it to its maximum potential.
...
2. Explore the [Solang SDK](https://solang.readthedocs.io/en/v0.3.3/index.html) and its role in compiling Solidity contracts into a format compatible with Solana.
...
5. Develop a comprehensive grasp of core Solana concepts, including [accounts](https://docs.solana.com/developing/programming-model/accounts), [programs](https://docs.solana.com/developing/intro/programs), [transactions](https://docs.solana.com/developing/programming-model/transactions), instructions, [CPI](https://docs.solana.com/developing/programming-model/calling-between-programs), and [PDA](https://solanacookbook.com/core-concepts/pdas.html).
6. Conceive and construct a Solidity Solana program for minting Solana [SPL tokens](https://spl.solana.com/token).
...
8. Learn to develop Solana programs and achieve the capability to transfer your minted Gold SPL tokens to another person's [ATA](https://spl.solana.com/associated-token-account).
...
The course comprises eight modules, each dedicated to a specific topic. Every lession starts with a clear outline of its objectives, providing a preview of the lession's content.

Each lession consists of two parts:

- **Overview -** A concise introduction to the lession's content, offering an initial understanding of the topic.
- **Demo -** A tutorial-style project related to the lession's content, designed to reinforce your understanding.
