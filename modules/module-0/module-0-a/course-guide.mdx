...
<div style={{display: 'flex', alignItems: 'center'}}>
  <img src="https://res.cloudinary.com/ddwkxn8ak/image/upload/v1699179782/solangsol/site-logo_y2z19w.svg" alt="Logo" style={{width: '50px', height: '50px', marginRight: '10px'}} />
  <h1>Solidity On Solana</h1>
</div>