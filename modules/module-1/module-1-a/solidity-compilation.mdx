...
In the following lession, you will be able to:
...
![Solidity on Eth](/moduleimages/com_eth.jpg)
...
In the next lession, we will explore Solang, the Solidity compiler in depth.
