...
In this lession, we briefly go through the content of the course, where we will be transferring Solana tokens using Solidity.
...
The code for this module is located here:- [transfer spl tokens](https://github.com/shivamsoni00/transfergold/tree/master)
