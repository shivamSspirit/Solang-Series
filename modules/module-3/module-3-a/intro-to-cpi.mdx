...
In this lesson, we go through the contents of this module, where we learn how to build a CPI enabled Flip program on Solidity.
...
The code for the project is located [here](https://github.com/shivamsoni00/flipcpi).